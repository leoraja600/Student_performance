...
export const config = {
  ...
  scoring: {
    leetcodeMax: parseInt(process.env.LEETCODE_MAX_SCORE || '8000', 10),
    leetcodeWeight: parseInt(process.env.LEETCODE_WEIGHT || '40', 10),
    hackerrankMax: parseInt(process.env.HACKERRANK_MAX_SCORE || '100', 10),
    hackerrankWeight: parseInt(process.env.HACKERRANK_WEIGHT || '25', 10),
    hackathonMax: parseInt(process.env.HACKATHON_MAX_SCORE || '25', 10),
